...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.text4=Text(self,width=50,height=14,wrap=WORD)
    ...
    def bigprogram(self):
            ...
            if ((From in liststations) and (To in liststations) and (cardtype in card)):
                ...
                if(To=="Burjuman"):
                     message3= ["The feeder buses available are:","C2-Zabeel Park-Airport Terminal 2","C3-Hor Al Anz Bus Station-Karama Bus Station","C5-Gold Souq Bus Station-Ghubaiba Bus Station","C10-Hamriya Port-Jumeirah Beach Park"]
                if(To=="Al Karama"):
                     message3= ["The feeder buses available are:","C2-Airport Terminal 2–Zabeel Park","C10-Hamriya Port–Jumeirah Beach Park","C15 Hamriya Port–Al Wasl Park","C26-Al Wasl Park–Al Qusais-1 Industrial Area","21-Ghubaiba Bus Station–Al Quoz Ind. Area 4"]
                if(To=="Al Jafiliya"):
                     message3= ["The feeder buses available are:","C2-Zabeel Park–Airport Terminal 2","C15-Hamriya Port–Al Wasl Park Terminus","C26-Al Wasl Park Terminus–Al Qusais-1 Industrial Area","X10-Gold Souq Bus Station–Al Quoz Bus Station","X28-Lulu Village–Nakheel MS"]
                ...
                if(To=="Emirates Towers"):
                     message3= ["The feeder buses available are:","F11 Financial Centre MS – Satwa","21-Ghubaiba Bus Station–Al Quoz Ind. Area 4","27-Gold Souq Bus Station–Dubai Mall"]
                ...
                if(To=="Ibn Battuta"):
                     message3= ["The feeder buses avaliable are:","E101-Abu Dhabi–Ibn Batutta","F43-Ibn Battuta MS–Discovery Gardens","F44-Ibn Battuta MS–The Gardens","F46-Ibn Battuta MS–IMP Zone","F48-Ibn Battuta MS–Dubai Investment Park"]
                if(To=="Jebel Ali"):
                ...
                if(To=="Airport Free Zone"):
                     message3= ["The feeder buses avaliable are:","13-Gold Souq Bus Station–Al Qusais-1 Bus Station","17-Al Sabkha Bus Station–Al Qusais-1 Bus Station ","C18-Shaikh Rashid Colony,Al Qusais-1–Lamcy Plaza ","C19-Ghubaiba Bus Station–Al Qusais-1 Industrial Area"]
                if(To=="Al Nahda"):
                     message3= ["The feeder buses avaliable are:","13 Gold Souq Bus Station–Al Qusais-1 Bus Station","13A Gold Souq Bus Station–Al Qusais-1 Bus Station","17 Al Sabkha Bus Station–Al Qusais-1 Bus Station","22 Healthcare City–Al Nahda 1","31 Gold Souq Bus Station–Oud Al Mateena"]
                if(To=="Rashid Stadium"):
                     message3= ["The feeder buses available are:","13-Gold Souq Bus Station–Al Qusais-1 Bus Station","13A Gold Souq Bus Station–Al Qusais-1 Bus Station","17 Al Sabkha Bus Station–Al Qusais-1 Bus Station","22 Healthcare City–Al Nahda 1","64 Gold Souq Bus Station–Ras Al Khor"]
                if(To=="Al Qiyadah"):
                     message3= ["The feeder buses available are:","C9-Al Satwa Bus Station–Hor Al Anz East"]
                if(To=="Abu Hail"):
                     message3= ["The feeder buses available are:","13 Gold Souq Bus Station–Al Qusais-1 Bus Station","13A Gold Souq Bus Station–Al Qusais-1 Bus Station","48 Mamzar"," Century Mall–Al Rashidiya  MS","C3 Hor Al Anz Bus Station–Karama Bus Station","C7 Hor Al Anz Bus Station–Healthcare City","C9 Satwa Bus Station–Hor Al Anz East"]
                ...
                if(To=="Oud Metha"):
                     message3= ["The feeder buses available are:","22-Healthcare City – Al Nahda 1","42-Ghubaiba Bus Station-Airport Airport Terminal-1","44-Ghubaiba Bus Station-Dubai Festival City","61D-Ghubaiba Bus Station-Nad Al Sheba Clinic","66-Ghubaiba Bus Station-Faqa Terminus","C4-Gold Souq Bus Station-Jadaf","C7-Hor Al Anz Bus Station-Healthcare City","X23-Gold Souq Bus Station–International City"]
                if (To=="Nakheel Harbor & Tower"):
                     message3=["No feeder buses available"]
                if (To=="Creek"):
                     message3=["No feeder buses available"]
                if (To=="Sharaf DG"):
                     message3=["No feeder buses available"]

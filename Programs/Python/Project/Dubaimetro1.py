...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.filebutton=Button(self,text="save search",command=self.fileprog)
        self.filebutton.grid(row=7,column=0)
        self.filebutton1=Button(self,text="use my saved search",command=self.fileprogram)
        self.filebutton1.grid(row=6,column=2)
        self.newgui=Button(self,text="rta",command=self.rta)
        self.newgui.grid(row=7,column=4)
        ...
        self.text.grid(row=1,column=4,columnspan=2,sticky=W)
        self.text2=Text(self,width=50,height=2,wrap=WORD)
        self.text2.grid(row=2,column=4,columnspan=4,sticky=W)
        self.text3=Text(self,width=50,height=2,wrap=WORD)
        self.text3.grid(row=3,column=4,columnspan=4,sticky=W)
        self.text4=Text(self,width=50,height=2,wrap=WORD)
        self.text4.grid(row=4,column=4,columnspan=4,sticky=W)
    ...
    def fileprog(self):
                ...
                To=self.var2.get()
                cardtype=self.card.get()
                list1=[From,To,cardtype]
                pickle.dump(list1,x)
                x.close()                                    
    def fileprogram(self):
                x=open("new.dat","rb")
                try:
                    while True:
                        m=pickle.load(x)
    ...
    def rta(self):
        ...
        root1.title("Metro Planner")
        root1.geometry("750x649")
        app1=Application1(root1)
        app1.grid()
        root1.mainloop()
...
root=Tk()
p = PhotoImage(file="C:\Users\Compaq\Desktop\Dubai_Metro_03.gif")
